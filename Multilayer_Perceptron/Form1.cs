...
namespace LabWork4
{
    public partial class Form1 : Form
    {
        ...
        private void pictureButtonTest_Click(object sender, EventArgs e)
        {
            ...
            selectPicture.Text = "Choose test image";
        ...
        private void teachButton_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i <= 5; i++)
                ...
                {
                    MessageBox.Show("Not all the image is load!");
                    return;
                }
        ...
        private void runButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Test image isn`t load!");
                return;
            }
            else if (!is_teached)
            {
                MessageBox.Show("Network isn`t teached!");
                return;
            }
        ...
        private bool addImage(PictureBox pb, int number)
        {
            ...
            {
                MessageBox.Show("The image size is wrong!");
                return false;
            }
